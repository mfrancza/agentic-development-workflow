...
> **Amendment (Issue [#343](https://github.com/mfrancza/agentic-development-workflow/issues/343) closing comment, 2026-09-06):** The generator-script approach described in this design was rescoped before implementation. The generator script (`scripts/generate-docs.sh`) was never merged, nor was the CI drift check (Issue [#345](https://github.com/mfrancza/agentic-development-workflow/issues/345)). Instead, the three volatile `AGENTS.md` sections (labels, AGENT_ACTION table, workflow triggers) were converted to **imperative source pointers** — short paragraphs naming the authoritative file and instructing agents to read it directly. The markers inserted by Issue [#341](https://github.com/mfrancza/agentic-development-workflow/issues/341) were removed as part of Issue [#431](https://github.com/mfrancza/agentic-development-workflow/issues/431). The rationale for preferring links over generation is in the [#343 closing comment](https://github.com/mfrancza/agentic-development-workflow/issues/343#issuecomment-5560708916). This design doc is retained as historical record.
